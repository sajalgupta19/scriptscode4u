...
function CodeColor(elmnt, mode) {
  ...
  var tagcolor = "#55efc4";//soft-cyan
  var tagnamecolor = "#f39c12";//oranges
  var attributecolor = "#ff7979";//redpink
  ...
  var csspropertyvaluecolor = "26c5d2";
  var cssdelimitercolor = "#7ed6df";
  var cssimportantcolor = "#3498db";  
  var jscolor = "black";
  var jskeywordcolor = "mediumblue";
  var jsstringcolor = "#3498db";
  var jsnumbercolor = "#3498db";
